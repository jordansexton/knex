...
(0, _lodash.assign)(Builder.prototype, {
  ...
  withRecursive: function withRecursive(alias, statement, recursive) {
    if (typeof alias !== 'string') {
    ...
    if (
      ...
      (typeof recursive === 'function' ||
        ...
        recursive instanceof _raw2.default)
    ) {
  ...
  withRecursiveWrapped: function withRecursiveWrapped(alias, query, recursive) {
    this._statements.push({
      grouping: 'with',
  ...
  onConflict: function onConflict(columns, updates) {
